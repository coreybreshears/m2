// Be advised when updating, this file is edited, search :EDITED:
...
(function(a) {
    a.extend(a.jqx._jqxGrid.prototype, {
        autoresizecolumns: function(z, g) {
            ...
            // :EDITED: Not sure what this does, but this breaks functionality on window resize
            //   columns just reverts back to its original undesired widths
//            for (var v = 0; v < this.columns.records.length; v++) {
//                var d = this.columns.records[v];
