    ...
    tt_aElt[0].innerHTML =
        (''
            ...
            ('<div id="WzTiTl" style="position:relative;z-index:1;">'
                ...
                + '</tr></tbody></table></div>')
            : '')
            + '<div id="WzBoDy" style="position:relative;z-index:0;visibility:' + (tt_sContent.length ? 'show' : 'hidden') + '">'
            + '<table' + sTbTrTd + 'id="WzBoDyI" style="' + sCss + '">'
            + (tt_aV[ESCAPEHTML] ? tt_sContent.replace('<', '&lt;').replace('>', '&gt;') : tt_sContent)
