...
Mor::Application.routes.draw do
  ...
  #Stats URL aliases
  match '/stats/last_calls' => 'stats#call_list', via: [:get, :post]
  match '/stats/cc_call_list/:s_card_id' => 'stats#call_list', via: [:get, :post]

  match '404', to: redirect('/billing/test/_this_will_surely_never_exist'), via: [:get, :post]
